...
def entityTest():
    ...
    for document in response.documents:
        ...
        for entity in document.entities:
            ...
            if keyword not in keywords and "strong" not in keyword and "requirement" not in keyword and "startup" not in keyword and "us" not in keyword and "united states" not in keyword and "experience" not in keyword and "degree" not in keyword and "prefer" not in keyword and "diploma" not in keyword and "university" not in keyword and "knowledge" not in keyword and "year" not in keyword and "bachelor" not in keyword and "extract" not in keyword and len(keyword)>2:
